...
\subsubsection{Modulationsindex (Modulation Index)}
	...
	%$\qquad \beta \ll 1 \text{ (NB)} \qquad \Rightarrow \qquad W_{PM/FM} \approx 2 \omega_m$
	
	%$\qquad \beta \le 0.2 \qquad \qquad \Rightarrow \qquad \text{Kleinhubmodulation (Narrowband Angle Modulation)}$
	
	%$\qquad \beta > 1 \qquad \qquad \quad \Rightarrow \qquad \text{Grosshubmodulation (Wideband Angle Modulation)}$
