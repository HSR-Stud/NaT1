\section{Winkelmodulation (FM/PM)}
...
\begin{multicols}{2}
	\begin{center}
		...
		$ \Delta \omega = |\omega_i - \omega_c|_{max} = |\phi'|_{max}$ \\
...
\columnbreak
		...
		$\phi(t)$ momentane Phasenabweichung \\
		$|\phi|_{max}$ maximale Phasenabweichung \\
...
\subsection{Einton (Sinusförmige)-Modulation (Sinusoidal Modulation)}
...
\subsubsection{Direkte Grosshub Modulation}
